    ...
    <div className="h-screen bg-gray-100 overflow-y-scroll">
      ...
      <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 ">
        <button
          ...
          className="px-4 py-2 mb-10 mt-4 mx-2 text-xl font-semibold text-center text-white  bg-gradient-to-r from-[#50B389] via-[#328B6E] to-[#095748] transition duration-300 rounded-lg hover:opacity-75 flex items-center ease md:w-auto"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <div className="relative overflow-x-auto sm:rounded-lg mx-2">
          <table className="w-full border-separate border-spacing-y-4  text-sm text-left rtl:text-right text-gray-500">
            ...
            <tbody>
              {sortedCustomer?.map((data: any, index: any) => {
                const { customerName, userName, email, profilePicture } = data;
                const dataUrl = profilePicture?.data
                  ? `data:image/png;base64,${btoa(
                      String.fromCharCode.apply(null, profilePicture.data.data)
                    )}`
                  : '';
                    ...
                    <td className="px-6 py-4 rounded-r-lg">
                      <div className="flex justify-evenly items-center">
                        ...
                        <button
                          ...
                          className="px-4 py-[2px] ml-2 font-medium text-red-600 bg-red-500/50 rounded hover:underline"
                        >
                          Delete
                        </button>
                      </div>
