        ...
        <Transition.Root show={mobileFiltersOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-primary-color py-4 pb-12 shadow-xl">
                  {/* Filters */}
                  <button
                    onClick={() => setMobileFiltersOpen(false)}
                    className="mr-2 text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center hover:opacity-60"
                  >
                    <svg
                      className="w-3 h-3"
                      aria-hidden="true"
